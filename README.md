...
- **Overridable block renderers and perf instrumentation** ⏳ — designed in [`prd.md`](./prd.md), not yet built.
...
Streaming (`useMarkdownStream`), overridable per-block renderers and performance instrumentation are designed but not yet built — see [`prd.md`](./prd.md) for the full specification and [`plan.md`](./plan.md) for the decisions and spike results behind it.
